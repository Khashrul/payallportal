                ...
                <div class="col-md-12 col-xs-12 pull-left form-box">
                    ...
                    <div class="pull-left col-md-4">
                        <div class="card card-container">
                            ...
                            <form id="loginForm" name="loginForm" autocomplete="off" action="dashboard.php" method="post" onsubmit="return disableSubmit(this)"><input type="hidden" name="csrf" value="l3375a769jrom2l66t21u5u7o6">
                                <div class="form-signin">
                                    <span id="reauth-email" class="reauth-email"></span>

                                    <p class="pull-left">Merchant ID</p>
                                    <input type="text" name="ownerId" id="ownerId" value="" autocomplete="off" autofocus="" class="form-control">

                                    <p class="pull-left">Merchant Name</p>
                            ...
                            <p class=" small pull-right">
                                <a id="resetPasswordLink" href="./resetPassword.s" class="forgot-password">Forgot Password</a>
                            </p>
                        </div>
