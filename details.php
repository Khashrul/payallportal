                                    ...
                                    <div class="row-fluid">
                                        <div id="detail-summary" class="summary-section summary">
                                            ...
                                            <table class="table detail-table" order-summary-date-update="">
                                                <tbody><tr ng-show="$parent.isMerchantManager" data-udm-field="merchantId" class="ng-isolate-scope ng-scope" style="display: none;"><td id="merchantId-label" class="detail-label ng-binding">Merchant ID</td><td id="merchantId-value" class="detail-value ng-binding">50040005</td></tr><tr data-ng-show="$parent.showLineOfBusiness()" data-udm-field="lineOfBusiness" class="ng-isolate-scope ng-scope" style="display: none;"><td id="lineOfBusiness-label" class="detail-label ng-binding" style="display: none;"></td><td id="lineOfBusiness-value" class="detail-value ng-binding" style="display: none;"></td></tr><tr data-udm-field="orderOutstandingAuthorizationAmount" class="ng-isolate-scope ng-scope"><td id="orderOutstandingAuthorizationAmount-label" class="detail-label ng-binding">Outstanding Invoice Id</td><td id="orderOutstandingAuthorizationAmount-value" class="detail-value ng-binding">8496761969</td></tr><tr ng-show="$parent.showTotalCapturedAmount()" data-udm-field="orderTotalCapturedAmount" class="ng-isolate-scope ng-scope"><td id="orderTotalCapturedAmount-label" class="detail-label ng-binding">Captured Amount</td><td id="orderTotalCapturedAmount-value" class="detail-value ng-binding">24,000.00 BDT</td></tr><tr ng-show="$parent.showTotalRefundedAmount()" data-udm-field="orderTotalRefundedAmount" class="ng-isolate-scope ng-scope" style="display: none;"><td id="orderTotalRefundedAmount-label" class="detail-label ng-binding">Refunded Amount</td><td id="orderTotalRefundedAmount-value" class="detail-value ng-binding">0.00 BDT</td></tr><tr data-udm-field="orderRequestedAmount" class="ng-isolate-scope ng-scope"><td id="orderRequestedAmount-label" class="detail-label ng-binding" style="display: none;">Requested Order Amount</td><td id="orderRequestedAmount-value" class="detail-value ng-binding" style="display: none;"></td></tr><tr data-udm-field="orderId" class="ng-isolate-scope ng-scope"><td id="orderId-label" class="detail-label ng-binding">Order ID</td><td id="orderId-value" class="detail-value ng-binding">1496761969</td></tr><tr data-udm-field="orderCreationDate" class="ng-isolate-scope ng-scope"><td id="orderCreationDate-label" class="detail-label ng-binding">Order Date</td><td id="orderCreationDate-value" class="detail-value ng-binding">June 6, 2017 9:14pm</td></tr><tr data-udm-field="merchantOrderReference" class="ng-isolate-scope ng-scope"><td id="merchantOrderReference-label" class="detail-label ng-binding" style="display: none;">Order Reference</td><td id="merchantOrderReference-value" class="detail-value ng-binding" style="display: none;"></td></tr></tbody></table>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <div>
                                    <dl class="dl-horizontal">
                                        <div class="marquee">
                                            <table>
                                                <tbody><tr>
                                                    <td class="right statuses">
                                                        <table class="marquee-status" ng-class="{'risk': showRiskInMarquee()}">
                                                            <tbody><tr>
                                                                <td><span id="orderStatus-value" class="detail-status ng-isolate-scope ng-scope ng-binding" data-udm-order-value="orderStatus">Captured</span></td>
                                                            </tr>
                                                            <tr ng-show="showRiskInMarquee()" style="display: none;">
                                                                <td><span id="riskAssessmentResult-marquee-value" class="detail-status green" data-udm-order-value=""></span></td>
                                                            </tr>
                                                            </tbody></table>
                                                    </td>
                                                    <td class="right actions small" ng-show="showActionList()">
                                                        <div class="btn-group">
                                                            <a class="btn dropdown-toggle ng-binding" data-toggle="dropdown" href="#">Actions <span class="caret"></span>
                                                            </a>
                                                            <ul class="dropdown-menu pull-right">
                                                                <!-- ngRepeat: action in getActionList() --><li ng-repeat="action in getActionList()" ng-class="{'disabled': true}" id="actionPAYMENT" ng-switch="" on="deriveInvokeType(action)" class="ng-scope disabled">
                                                                    <!-- ngSwitchWhen: LINK_DYNAMIC -->
                                                                    <!-- ngSwitchWhen: NO_INVOKE_PERMISSION -->
                                                                    <!-- ngSwitchDefault:  -->
                                                                    <a ng-switch-when="LINK_DYNAMIC" href="/historyV2/action/linkDynamic?_authDomain=ma&amp;dataSource=wsapi&amp;merchantId=50040005&amp;orderId=1496761969&amp;actionName=PAYMENT&amp;immediateLoad=false&amp;timezoneOffset=-360&amp;csrf=u7mnjrnsvo8dldlogepum5s1ql" target="_self" class="ng-scope ng-binding">Payment</a></li><li ng-repeat="action in getActionList()" ng-class="{'disabled': false}" id="actionREFUND" ng-switch="" on="deriveInvokeType(action)" class="ng-scope">
                                                                    <!-- ngSwitchWhen: LINK_DYNAMIC -->
                                                                    <!-- ngSwitchWhen: NO_INVOKE_PERMISSION -->
                                                                    <!-- ngSwitchDefault:  -->
                                                                    <a ng-switch-when="NO_INVOKE_PERMISSION" ng-click="showActionPermissionModal()" href="refund.php" class="ng-scope ng-binding">Refund</a></li><li ng-repeat="action in getActionList()" ng-class="{'disabled': true}" id="actionUPDATE_AUTHORIZATION" ng-switch="" on="deriveInvokeType(action)" class="ng-scope disabled">
                                                                    <!-- ngSwitchWhen: LINK_DYNAMIC -->
                                                                    <!-- ngSwitchWhen: NO_INVOKE_PERMISSION -->
                                                                    <!-- ngSwitchDefault:  -->
                                                                    <a ng-switch-default="" ng-click="doAction(action)" href="" class="ng-scope ng-binding">Update Authorization</a></li><li ng-repeat="action in getActionList()" ng-class="{'disabled': false}" id="actionVOID_LAST_TRANSACTION" ng-switch="" on="deriveInvokeType(action)" class="ng-scope">
                                                                    <!-- ngSwitchWhen: LINK_DYNAMIC -->
                                                                    <!-- ngSwitchWhen: NO_INVOKE_PERMISSION -->
                                                                    <!-- ngSwitchDefault:  -->
                                                                    <a ng-switch-default="" ng-click="doAction(action)" href="voided.php" class="ng-scope ng-binding">Void Last Transaction</a></li><li ng-repeat="action in getActionList()" ng-class="{'disabled': false}" id="actionCLONE_ORDER" ng-switch="" on="deriveInvokeType(action)" class="ng-scope">
                                                                    <!-- ngSwitchWhen: LINK_DYNAMIC -->
                                                                    <!-- ngSwitchWhen: NO_INVOKE_PERMISSION -->
                                                                    <!-- ngSwitchDefault:  -->
                                                                    <a ng-switch-when="NO_INVOKE_PERMISSION" ng-click="showActionPermissionModal()" href="" class="ng-scope ng-binding">Clone</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
                                    ...
                                    <hr>
                                    <tr data-udm-field="cardFundingMethod" class="ng-isolate-scope ng-scope">
                                        <td id="cardFundingMethod-label" class="detail-label ng-binding">Customer Name :</td>
                                        <td id="cardFundingMethod-value" class="detail-value ng-binding"> Katherine Frate</td>
                                    </tr>
                                    <br>
                                    <tr data-udm-field="cardFundingMethod" class="ng-isolate-scope ng-scope">
                                        <td id="cardFundingMethod-label" class="detail-label ng-binding">Email :</td>
                                        <td id="cardFundingMethod-value" class="detail-value ng-binding">xyz@gmail.com</td>
                                    </tr>
                                </div>
