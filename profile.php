            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12 pull-right form-box">
                    ...
                    <div class="details-bottom">
                            ...
                            <div class="pull-left col-md-4"></div>
                                ...
                                <div class="card card-container">
                                    <form id="loginForm" name="loginForm" autocomplete="off" action="/ma/login.s?" method="post" onsubmit="return disableSubmit(this)"><input type="hidden" name="csrf" value="l3375a769jrom2l66t21u5u7o6">
                                        <div class="form-signin">
                                            ...
                                            <p class="pull-left">Current Password</p>
                                            <input type="password" name="password" id="password"  autocomplete="off" autofocus="" class="form-control">

                                            <p class="pull-left">New Password</p>
                                            <input type="password" name="password" id="password" autocomplete="off" class="form-control">

                                            <p class="pull-left">Confrim Password</p>
                                            <input type="password" name="password" id="password" autocomplete="off" class="form-control">

                                            <input class="btn btn-lg btn-primary btn-block btn-signin" type="submit" value="SUBMIT" name="loginForm">
                                        </div>
